  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-300">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-950 text-cyan-400 text-sm font-medium mb-8 border border-cyan-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          <div className="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl flex flex-col items-center">
      ...
      <section className="bg-slate-800/30 border-y border-slate-800 py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="space-y-6 text-lg text-slate-300 text-left bg-slate-800 p-8 rounded-2xl border border-slate-700">
            <p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[1, 2, 3, 4].map((member) => (
            <div key={member} className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 text-center hover:border-cyan-500/50 transition-colors group">
              <div className="w-24 h-24 bg-slate-700 rounded-full mx-auto mb-4 border-2 border-transparent group-hover:border-cyan-400 overflow-hidden flex items-center justify-center text-slate-500">
                [Photo]
              </div>
      ...
      <footer className="border-t border-slate-800 bg-slate-900 py-8 text-center text-slate-500">
        <p>Demo mode — simulated data. Not for production use.</p>
        <p className="mt-2 text-sm">© 2026 [Your Team Name]. SIH Project.</p>
      </footer>
    </div>
  );
}
